...
// Importing Logos
import addClassroom from "../assets/images/AddClassroom.svg";
...
export default class AddClassroom extends Component {
    ...
    submit = (event) => {
        ...
        axios({
            url: "http://localhost:5000/classroom/add",
            method: "POST",
            data: payLoad,
        })
            .then(() => {
                console.log("Add Class Data has been sent to the server");
                this.setState({
                    message: "Class has been added to the server",
                    alertType: "success",
                });
            })
            .catch(() => {
            ...
            <Container className="App-header py-5">
                ...
                <Row>
                    ...
                    <Col sm="9" className="App-header">
                        <h1 className={this.props.mode}>Add Classroom</h1>
                    </Col>
                </Row>
